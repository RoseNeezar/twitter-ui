...
const LeftPanelNav = () => {
  return (
    <nav className="mt-5">
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-blue-400 transition ease-in-out xl:justify-start duration-350"
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">Home</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-gray-800 transition ease-in-out xl:justify-start dark:text-white hover:text-blue-400 dark:hover:text-blue-400 duration-350"
      >
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
          <path
            strokeLinecap="round"
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">Explore</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-gray-800 transition ease-in-out xl:justify-start dark:text-white hover:text-blue-400 dark:hover:text-blue-400 duration-350"
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">
          Notifications
        </span>
      </a>
      <a
      ...
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">Messages</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-gray-800 transition ease-in-out xl:justify-start dark:text-white hover:text-blue-400 dark:hover:text-blue-400 duration-350"
      ...
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">Lists</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-gray-800 transition ease-in-out xl:justify-start dark:text-white hover:text-blue-400 dark:hover:text-blue-400 duration-350"
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">Profile</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center mb-8 text-gray-800 transition ease-in-out xl:justify-start dark:text-white hover:text-blue-400 dark:hover:text-blue-400 duration-350"
      >
        ...
        <span className="hidden ml-4 font-bold xl:block text-md">More</span>
      </a>
      <a
        href="#"
        className="flex items-center justify-center py-3 mx-auto mb-10 font-bold text-white transition ease-in-out bg-blue-400 rounded-full w-11 h-11 xl:w-auto hover:bg-blue-500 font-sm duration-350"
      >
        <svg
          fill="currentColor"
          viewBox="0 0 24 24"
        ...
        <span className="hidden font-bold xl:block text-md">Tweet</span>
      </a>
    </nav>
  );
};
